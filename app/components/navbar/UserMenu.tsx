...
const UserMenu: React.FC<UserMenuProps> = ({ currentUser }) => {
  ...
  return (
    <div className="relative">
      <div className="flex itemcenter gap-3">
        <div
          onClick={onRent}
          className="hidden whitespace-nowrap md:block text-sm font-semibold py-3 px-4 rounded-full hover:bg-neutral-100 transition cursor-pointer"
        >
          Renthabitapp home
        </div>
        <div
